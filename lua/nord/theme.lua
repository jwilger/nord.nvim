...
theme.loadSyntax = function()
	...
	return {
		...
		Comment = { fg = nord.nord15_gui, style = italic }, -- italic comments
...
theme.loadTreeSitter = function()
	...
	-- Comments
	treesitter.TSComment = { fg = nord.nord15_gui, style = italic }
	-- Conditionals
	...
	treesitter["@comment"] = { fg = nord.nord15_gui, style = italic }
...
theme.loadPlugins = function()
	...
	local plugins = {
		...
		-- copilot
		CopilotLabel = { fg = nord.nord15_gui, bg = nord.none },
